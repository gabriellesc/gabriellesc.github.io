...
(function(Opal) {
  ...
  Opal.add_stubs(['$attr_reader', '$remove', '$add', '$const_defined?', '$opacity', '$color', '$opacity=', '$raise', '$map', '$new', '$[]', '$length', '$each', '$!', '$is_valid?', '$class', '$===', '$==', '$rand', '$is_hex?', '$hex_to_f', '$key?', '$all?', '$is_a?', '$include?', '$private', '$push', '$/', '$to_proc', '$each_slice', '$chars', '$to_i', '$to_f', '$attr_accessor', '$next', '$add_object', '$index', '$delete_at', '$clear', '$has_key?', '$new_event_key', '$[]=', '$delete', '$type', '$id', '$downcase', '$call', '$to_sym', '$ext_show', '$ext_close', '$>', '$z', '$insert', '$get', '$set', '$on', '$off', '$update', '$show', '$close', '$include', '$color=', '$from', '$update_color', '$+', '$triangle_area', '$<=', '$abs', '$-', '$*', '$points_distance', '$<', '$x1', '$y1', '$x2', '$y2', '$sqrt', '$**', '$update_coords', '$width=', '$height=', '$ext_init', '$clip', '$merge!', '$!=', '$animate_frames', '$clip_with_current_frame', '$to_s', '$ext_set', '$=~', '$exists?', '$ext_play', '$ext_pause', '$ext_resume', '$ext_stop', '$ext_fadeout']);
  (function($base) {
...
;
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      return (Opal.defn(self, '$ext_render', TMP_1 = function $$ext_render() {
        var self = this;
    ...
    (function($base, $super) {
      ...
      return (Opal.defn(self, '$ext_render', TMP_2 = function $$ext_render() {
        var self = this;
    ...
    (function($base, $super) {
      ...
      return (Opal.defn(self, '$ext_render', TMP_3 = function $$ext_render() {
        var self = this;
    ...
    (function($base, $super) {
      ...
      Opal.defn(self, '$ext_init', TMP_4 = function $$ext_init(path) {
        var self = this;
      ...
      return (Opal.defn(self, '$ext_render', TMP_5 = function $$ext_render() {
        var self = this;
    ...
    (function($base, $super) {
      ...
      Opal.defn(self, '$ext_init', TMP_6 = function $$ext_init(path) {
        var self = this;

        return self.data = S2D.CreateSprite(path);;
      }, TMP_6.$$arity = 1);

      return (Opal.defn(self, '$ext_render', TMP_7 = function $$ext_render() {
        var self = this;
    ...
    (function($base, $super) {
      ...
      var def = self.$$proto, $scope = self.$$scope, TMP_8, TMP_9, TMP_10;

      def.width = def.height = nil;
      Opal.defn(self, '$ext_init', TMP_8 = function $$ext_init() {
        var self = this;
      ...
      Opal.defn(self, '$ext_set', TMP_9 = function $$ext_set(msg) {
        var self = this;
      ...
      return (Opal.defn(self, '$ext_render', TMP_10 = function $$ext_render() {
        var self = this;
    ...
    (function($base, $super) {
      ...
      Opal.defn(self, '$ext_init', TMP_11 = function $$ext_init(path) {
        var self = this;

        return self.data = S2D.CreateSound(path);;
      }, TMP_11.$$arity = 1);

      return (Opal.defn(self, '$ext_play', TMP_12 = function $$ext_play() {
        var self = this;

        return S2D.PlaySound(self.data);;
      }, TMP_12.$$arity = 0), nil) && 'ext_play';
    })($scope.base, null);
    ...
    (function($base, $super) {
      ...
      var def = self.$$proto, $scope = self.$$scope, TMP_13, TMP_14, TMP_15, TMP_16, TMP_17, TMP_18;

      Opal.defn(self, '$ext_init', TMP_13 = function $$ext_init(path) {
        var self = this;

        return self.data = S2D.CreateMusic(path);;
      }, TMP_13.$$arity = 1);

      Opal.defn(self, '$ext_play', TMP_14 = function $$ext_play() {
        var self = this;

        return S2D.PlayMusic(self.data, self.loop);;
      }, TMP_14.$$arity = 0);

      Opal.defn(self, '$ext_pause', TMP_15 = function $$ext_pause() {
        var self = this;

        S2D.PauseMusic();
      }, TMP_15.$$arity = 0);

      Opal.defn(self, '$ext_resume', TMP_16 = function $$ext_resume() {
        var self = this;

        S2D.ResumeMusic();
      }, TMP_16.$$arity = 0);

      Opal.defn(self, '$ext_stop', TMP_17 = function $$ext_stop() {
        var self = this;

        S2D.StopMusic();
      }, TMP_17.$$arity = 0);

      return (Opal.defn(self, '$ext_music_fadeout', TMP_18 = function $$ext_music_fadeout(ms) {
        var self = this;

        S2D.FadeOutMusic(ms);
      }, TMP_18.$$arity = 1), nil) && 'ext_music_fadeout';
    })($scope.base, null);
    ...
    (function($base, $super) {
      ...
      return (Opal.defn(self, '$ext_show', TMP_19 = function $$ext_show() {
        var self = this;
        if ($gvars.R2D_WINDOW == null) $gvars.R2D_WINDOW = nil;
...
/* Generated by Opal 0.10.5 */
(function(Opal) {
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $hash2 = Opal.hash2, green = nil;

  Opal.add_stubs(['$set', '$new', '$show']);
  self.$set($hash2(["width", "height", "viewport_width", "viewport_height", "background"], {"width": 240, "height": 280, "viewport_width": 240, "viewport_height": 280, "background": "white"}));
  green = "#3dc06c";
  $scope.get('Rectangle').$new($hash2(["x", "y", "width", "height", "color"], {"x": 0, "y": 0, "width": 240, "height": 190, "color": "black"}));
  $scope.get('Rectangle').$new($hash2(["x", "y", "width", "height", "color"], {"x": 20, "y": 20, "width": 200, "height": 150, "color": "white"}));
  $scope.get('Rectangle').$new($hash2(["x", "y", "width", "height", "color"], {"x": 40, "y": 40, "width": 160, "height": 110, "color": "black"}));
  $scope.get('Rectangle').$new($hash2(["x", "y", "width", "height", "color"], {"x": 80, "y": 190, "width": 80, "height": 20, "color": "black"}));
  $scope.get('Rectangle').$new($hash2(["x", "y", "width", "height", "color"], {"x": 20, "y": 210, "width": 200, "height": 20, "color": "black"}));
  $scope.get('Rectangle').$new($hash2(["x", "y", "width", "height", "color"], {"x": 0, "y": 230, "width": 240, "height": 50, "color": "black"}));
  $scope.get('Square').$new($hash2(["x", "y", "size", "color"], {"x": 40, "y": 250, "size": 20, "color": "white"}));
  $scope.get('Square').$new($hash2(["x", "y", "size", "color"], {"x": 80, "y": 250, "size": 20, "color": "white"}));
  $scope.get('Square').$new($hash2(["x", "y", "size", "color"], {"x": 120, "y": 250, "size": 20, "color": "white"}));
  $scope.get('Square').$new($hash2(["x", "y", "size", "color"], {"x": 160, "y": 250, "size": 20, "color": "white"}));
  $scope.get('Square').$new($hash2(["x", "y", "size", "color"], {"x": 60, "y": 230, "size": 20, "color": "white"}));
  $scope.get('Square').$new($hash2(["x", "y", "size", "color"], {"x": 100, "y": 230, "size": 20, "color": "white"}));
  $scope.get('Square').$new($hash2(["x", "y", "size", "color"], {"x": 140, "y": 230, "size": 20, "color": "white"}));
  $scope.get('Square').$new($hash2(["x", "y", "size", "color"], {"x": 180, "y": 230, "size": 20, "color": "white"}));
  $scope.get('Square').$new($hash2(["x", "y", "size", "color"], {"x": 40, "y": 60, "size": 20, "color": green}));
  $scope.get('Square').$new($hash2(["x", "y", "size", "color"], {"x": 80, "y": 60, "size": 20, "color": green}));
  $scope.get('Square').$new($hash2(["x", "y", "size", "color"], {"x": 120, "y": 60, "size": 20, "color": green}));
  $scope.get('Rectangle').$new($hash2(["x", "y", "width", "height", "color"], {"x": 60, "y": 100, "width": 40, "height": 20, "color": green}));
  $scope.get('Rectangle').$new($hash2(["x", "y", "width", "height", "color"], {"x": 120, "y": 100, "width": 40, "height": 20, "color": green}));
  return self.$show();
})(Opal);
